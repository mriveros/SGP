 ...
 $ruta=$_SERVER['SERVER_NAME'].":".$_SERVER['SERVER_PORT']."";
   ...
   if  (empty($_POST['txtCodigoFacturaNORETEN'])){$codigoFacturaSINRETENCION=0;}else{$codigoFacturaSINRETENCION=$_POST['txtCodigoFacturaNORETEN'];}
		...
		alert("La retencion ya existe. Ingrese otra retencion");
                window.location="http://$ruta/SGP/web/rentenciones/ABMretencion.php";
		</script>';
                }else{              
                //se define el Query   
                ...
                $query = '';
                header("Refresh:0; url=http://$ruta/SGP/web/retenciones/ABMretencion.php");
                }
            }
        //si es Modificar    
        ...
        header("Refresh:0; url=http://$ruta/SGP/web/facturacion/Retenciones.php");
	}
