...
$ruta=$_SERVER['SERVER_NAME'].":".$_SERVER['SERVER_PORT']."";
    ...
    if  (empty($_POST['txtCodigoE'])){$codigoElim=0;}else{$codigoElim=$_POST['txtCodigoE'];}
		...
		alert("La Dependencia ya existe. Ingrese otra dependencia");
                window.location="http://<?php echo $ruta;?>/SGP/web/dependencias/ABMdependencia.php";
		</script>';
                }else{              
                //se define el Query   
                ...
                $query = '';
                header("Refresh:0; url=http://<?php echo $ruta;?>/SGP/web/dependencias/ABMdependencia.php");
                }
            }
        //si es Modificar    
