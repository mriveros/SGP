...
<head>
    ...
    <title>SGP INTN- Puesto Usuario</title>
    <!-- Bootstrap Core CSS -->
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                      <h1 class="page-header">Puesto Usuario - <small>SGP INTN</small></h1>
                </div>	
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Listado de Usuario y sus Puestos
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                    <?php
                    $query = "select * from usuarios usu, puestos pues,puesto_usuario puesusu 
                    where pues.pues_cod=puesusu.pues_cod 
                    and usu.usu_cod=puesusu.usu_cod;";
                    $result = pg_query($query) or die ("Error al realizar la consulta");
                    while($row1 = pg_fetch_array($result))
                    {
                        $estado=$row1["pues_usu_activo"];
                        if($estado=='t'){$estado='Activo';}else{$estado='Inactivo';}
                        echo "<tr><td style='display:none'>".$row1["pues_usu_cod"]."</td>";
                        ...
                        <a onclick='modificar(<?php echo $row1["pues_usu_cod"];?>)' class="btn btn-success btn-xs active" data-toggle="modal" data-target="#modalmod" role="button">Modificar</a>
                        <a onclick='eliminar(<?php echo $row1["pues_usu_cod"];?>)' class="btn btn-danger btn-xs active" data-toggle="modal" data-target="#modalbor" role="button">Borrar</a>
                        <?php
                        echo "</td></tr>";
                    }
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
                                    <form  autocomplete="off" class="form-horizontal" name="agregarform" action="../class/ClsPuesto_Usuario.php" method="post" role="form">
						
                                        <div class="form-group">
                                            <label  class="col-sm-2 control-label" for="input01">Usuario</label>
                                            <div class="col-sm-10">
                                           <select name="txtUsuarioA" class="form-control" id="txtUsuarioA" required="true">
                                                <?php
                                                //esto es para mostrar un select que trae datos de la BDD
                                                conexionlocal();
                                                $query = "Select usu_cod,usu_nom ||' '||usu_ape from usuarios where usu_activo='t' ";
	...
	<div class="modal fade" id="modalmod" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<!-- Modal Body -->
				<div class="modal-body">
                                    <form  autocomplete="off" class="form-horizontal" name="modificarform" action="../class/ClsPuesto_Usuario.php"  method="post" role="form">
                                        <input type="numeric" name="txtCodigo" class="hide" id="txtCodigo" /> 
                                        <div class="form-group">
                                            <label  class="col-sm-2 control-label" for="input01">Usuario</label>
                                            <div class="col-sm-10">
                                           <select name="txtUsuarioM" class="form-control" id="txtUsuarioM" required="true">
                                                <?php
                                                //esto es para mostrar un select que trae datos de la BDD
                                                conexionlocal();
                                                $query = "Select usu_cod,usu_nom ||' '||usu_ape from usuarios where usu_activo='t' ";
	...
	<div class="modal fade" id="modalbor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<!-- Modal Body -->
				<div class="modal-body">
                                    <form class="form-horizontal" name="borrarform" action="../class/ClsPuesto_Usuario.php" onsubmit="return submitForm();" method="post" role="form">
						<div class="form-group">
