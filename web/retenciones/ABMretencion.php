	...
	<script type="text/javascript">
		function modificar(codigo){
			...
			var descripcion=document.getElementById("dataTables-example").rows[indi+1].cells[2].innerText;
                        ...
                        var minimo=document.getElementById("dataTables-example").rows[indi+1].cells[4].innerText;
			...
			document.getElementById("txtMontoM").value = minimo;
			});
		};
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                      <h1 class="page-header">Retenciones - <small>SGP-INTN</small></h1>
                </div>	
            </div>
            <!-- /.row -->
            <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                    <?php
                    $query = "select * from retenciones;";
                    $result = pg_query($query) or die ("Error al realizar la consulta");
                    while($row1 = pg_fetch_array($result))
                    {
                        $estado=$row1["ret_activo"];
                        if($estado=='t'){$estado='Activo';}else{$estado='Inactivo';}
                        echo "<tr><td style='display:none'>".$row1["ret_cod"]."</td>";
                        echo "<td>".$row1["ret_nom"]."</td>";
                        echo "<td>".$row1["ret_des"]."</td>";
                        echo "<td>".$row1["ret_porcentaje"]."</td>";
                        echo "<td>".$row1["ret_minimo"]."</td>";
                        echo "<td>".$estado."</td>";
                        echo "<td>";?>
                        
                        <a onclick='modificar(<?php echo $row1["ret_cod"];?>)' class="btn btn-success btn-xs active" data-toggle="modal" data-target="#modalmod" role="button">Modificar</a>
                        <a onclick='eliminar(<?php echo $row1["ret_cod"];?>)' class="btn btn-danger btn-xs active" data-toggle="modal" data-target="#modalbor" role="button">Borrar</a>
                        <?php
                        echo "</td></tr>";
                    }
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
                                    <form  autocomplete="off" class="form-horizontal" name="agregarform" action="../class/ClsRetenciones.php" method="post" role="form">
					...
					<div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" step="0.01" name="txtPorcentajeA" class="form-control" id="txtPorcentajeA" placeholder="ingrese porcentaje" required="true" />
                                            </div>
					</div>
                                        <div class="form-group">
                                            <label  class="col-sm-2 control-label" for="input01">Monto Mínimo</label>
                                            <div class="col-sm-10">
                                            <input type="number" name="txtMontoA" class="form-control" id="txtMontoA" placeholder="ingrese monto minimo" required="true" />
                                            </div>
					</div>
				</div>
				<!-- Modal Footer -->
	...
	<div class="modal fade" id="modalmod" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<!-- Modal Body -->
				<div class="modal-body">
                                    <form  autocomplete="off" class="form-horizontal" name="modificarform" action="../class/ClsRetenciones.php"  method="post" role="form">
                                        <div class="form-group">
                                            <div class="col-sm-10">
					...
					<div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label  class="col-sm-2 control-label" for="input01">Porcentaje</label>
                                            <div class="col-sm-10">
                                                <input type="number" step="0.01" name="txtPorcentajeM" class="form-control" id="txtPorcentajeM" placeholder="ingrese porcentaje" required="true" />
                                            </div>
					</div>
                                        <div class="form-group">
                                            <label  class="col-sm-2 control-label" for="input01">Monto Mínimo</label>
                                            <div class="col-sm-10">
                                            <input type="number" name="txtMontoM" class="form-control" id="txtMontoM" placeholder="ingrese monto minimo" required="true" />
                                            </div>
					</div>
                                        <div class="form-group">
