...
<head>
	...
	<script type="text/javascript">
		function modificar(codigo){
			$('tr').click(function() {
			indi = $(this).index();
                        var banco=document.getElementById("dataTables-example").rows[indi+1].cells[1].innerText;
                       	var nombre=document.getElementById("dataTables-example").rows[indi+1].cells[3].innerText;
			var descripcion=document.getElementById("dataTables-example").rows[indi+1].cells[4].innerText;
                        var anterior=document.getElementById("dataTables-example").rows[indi+1].cells[6].innerText;
                        var saldo=document.getElementById("dataTables-example").rows[indi+1].cells[7].innerText;
                        //var estado=document.getElementById("dataTables-example").rows[indi+1].cells[5].innerText;
                        document.getElementById("txtCodigo").value = codigo;
                        document.getElementById("txtBancoM").value= banco;
                        document.getElementById("txtNombreM").value = nombre;
			document.getElementById("txtDescripcionM").value = descripcion;
                        document.getElementById("txtSaldoAnteriorM").value = anterior;
                        document.getElementById("txtSaldoActualM").value = saldo;
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                      <h1 class="page-header">Cuentas Bancarias - <small>SGP INTN</small></h1>
                </div>	
            </div>
            <!-- /.row -->
            <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                    <?php
                    $query = "select * from cuentas cuen, bancos ban where cuen.ban_cod=ban.ban_cod;";
                    $result = pg_query($query) or die ("Error al realizar la consulta");
                    while($row1 = pg_fetch_array($result))
                    {
                        $estado=$row1["cuen_activo"];
                        if($estado=='t'){$estado='Activo';}else{$estado='Inactivo';}
                        echo "<tr><td style='display:none'>".$row1["cuen_cod"]."</td>";
                        echo "<td style='display:none'>".$row1["ban_cod"]."</td>";
                        echo "<td>".$row1["ban_nom"]."</td>";
                        echo "<td>".$row1["cuen_nom"]."</td>";
                        echo "<td>".$row1["cuen_des"]."</td>";
                        echo "<td>".$row1["cuen_fecha"]."</td>";
                        echo "<td>".$row1["cuen_anterior"]."</td>";
                        echo "<td>".$row1["cuen_saldo"]."</td>";
                        echo "<td>".$estado."</td>";
                        echo "<td>";?>
                        
                        <a onclick='modificar(<?php echo $row1["cuen_cod"];?>)' class="btn btn-success btn-xs active" data-toggle="modal" data-target="#modalmod" role="button">Modificar</a>
                        <a onclick='eliminar(<?php echo $row1["cuen_cod"];?>)' class="btn btn-danger btn-xs active" data-toggle="modal" data-target="#modalbor" role="button">Borrar</a>
                        <?php
                        echo "</td></tr>";
                    }
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
                                    <form  autocomplete="off" class="form-horizontal" name="agregarform" action="../class/ClsCuentas.php" method="post" role="form">
					<div class="form-group">
                                           ...
                                           <select name="txtBancoA" class="form-control" id="txtBancoA" required="true">
                                                ...
                                                conexionlocal();
                                                $query = "Select ban_cod,ban_nom from bancos where ban_activo='t' ";
                                        ...
                                        <div class="form-group">
                                            <label  class="col-sm-2 control-label" for="input01">Nombre Cuenta</label>
                                            <div class="col-sm-10">
	...
	<div class="modal fade" id="modalmod" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<!-- Modal Body -->
				<div class="modal-body">
                                    <form  autocomplete="off" class="form-horizontal" name="modificarform" action="../class/ClsCuentas.php"  method="post" role="form">
                                        <div class="form-group">
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group">
                                            <label  class="col-sm-2 control-label" for="input01">Banco</label>
                                            <div class="col-sm-10">
                                           <select name="txtBancoM" class="form-control" id="txtBancoM" required="true">
                                                <?php
                                                //esto es para mostrar un select que trae datos de la BDD
                                                conexionlocal();
                                                $query = "Select ban_cod,ban_nom from bancos where ban_activo='t' ";
					...
					<div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label  class="col-sm-2 control-label" for="input01">Saldo Anterior</label>
                                            <div class="col-sm-10">
                                                <input type="number" name="txtSaldoAnteriorM" class="form-control" id="txtSaldoAnteriorM" readonly="true" />
                                            </div>
					</div>
                                        <div class="form-group">
                                            <label  class="col-sm-2 control-label" for="input01">Saldo Actual</label>
                                            <div class="col-sm-10">
                                            <input type="number" name="txtSaldoActualM" class="form-control" id="txtSaldoActualM" readonly="true" />
                                            </div>
					</div>
                                        <div class="form-group">
	...
	<div class="modal fade" id="modalbor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<!-- Modal Body -->
				<div class="modal-body">
                                    <form class="form-horizontal" name="borrarform" action="../class/ClsCuentas.php" onsubmit="return submitForm();" method="post" role="form">
						<div class="form-group">
