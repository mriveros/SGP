...
<head>
    ...
    <title>SGP-INTN-Suministros</title>
    <!-- Bootstrap Core CSS -->
	...
	<script type="text/javascript">
		function modificar(codigo){
			$('tr').click(function() {
			indi = $(this).index();
                        var ivacod=document.getElementById("dataTables-example").rows[indi+1].cells[1].innerText;
                       	var nombre=document.getElementById("dataTables-example").rows[indi+1].cells[2].innerText;
			var descripcion=document.getElementById("dataTables-example").rows[indi+1].cells[3].innerText;
                        var precio=document.getElementById("dataTables-example").rows[indi+1].cells[4].innerText;
                        ...
                        document.getElementById("txtIVAM").value = ivacod;
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                      <h1 class="page-header">Suministros - <small>SGP-INTN</small></h1>
                </div>	
            </div>
            <!-- /.row -->
            <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                    <?php
                    $query = "select * from productos pro, iva iva where pro.iva_cod=iva.iva_cod";
                    $result = pg_query($query) or die ("Error al realizar la consulta");
                    while($row1 = pg_fetch_array($result))
                    {
                        $estado=$row1["pro_activo"];
                        $exentas=$row1["pro_exentas"];
                        if($estado=='t'){$estado='Activo';}else{$estado='Inactivo';}
                        if($exentas=='t'){$exentas='Activo';}else{$exentas='Inactivo';}
				...
				<div class="modal-body">
					...
					<div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                           <select name="txtIVAA" class="form-control" id="txtIVAA" required="true">
                                                <?php
                                                //esto es para mostrar un select que trae datos de la BDD
                                                conexionlocal();
                                                $query = "Select * from iva where iva_activo='t' ";
                                        ...
                                        <div class="form-group">
                                            <label  class="col-sm-2 control-label" for="input03">Exentas</label>
                                            <div class="col-sm-10">
                                            <div class="radio">
                                                <label><input type="checkbox" name="txtExentaA" value="1" />Exenta Parcial</label>
                                            </div>
                                            </div>
					</div>	
				...
				<div class="modal-body">
					...
					<div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label  class="col-sm-2 control-label" for="input01">IVA</label>
                                            <div class="col-sm-10">
                                           <select name="txtIVAM" class="form-control" id="txtIVAM" required="true">
                                                <?php
                                                //esto es para mostrar un select que trae datos de la BDD
                                                conexionlocal();
                                                $query = "Select * from iva where iva_activo='t' ";
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                            <div class="radio">
                                                <label><input type="checkbox" name="txtExentaM" value="1" />Exenta Parcial</label>
                                            </div>
                                            </div>
					</div>	
                                        <div class="form-group">
