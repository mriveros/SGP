...
function Header()
{
   // Select Arial bold 15
    ...
    $this->text(55,50,'RESUMEN DE COMPRAS POR PROVEEDOR');
...
$pdf->Cell(25,10,'Item',1,0,'C',50);
$pdf->Cell(25,10,'Observaciones',1,0,'C',50);
$pdf->Cell(25,10,'Subtotal',1,0,'C',50);
$pdf->Cell(50,10,'Total',1,0,'C',50);
