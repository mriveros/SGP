...
function Header()
{
   // Select Arial bold 15
    ...
    $this->text(37,29,"UNIDAD DE COMPRAS");
    $this->text(37,34,"Telefax: (595921) 295 408 e-mail: intn@intn.gov.py");
    ...
    $this->text(55,50,'RESUMEN DE PAGOS POR PROVEEDOR');
...
//----------------------------Build table---------------------------------------
$pdf->SetXY(10,100);
$pdf->Cell(20,10,'Item',1,0,'C',50);
$pdf->Cell(20,10,'Factura',1,0,'C',50);
$pdf->Cell(80,10,'Observaciones',1,0,'C',50);
$pdf->Cell(20,10,'Fecha',1,0,'C',50);
$pdf->Cell(20,10,'Total',1,0,'C',50);
$pdf->Cell(20,10,'IVA',1,1,'C',50);
$fill=false;
$i=0;
...
{   
    ...
    $pdf->Cell(20,5,$cantidad,1,0,'C',$fill);
    $pdf->Cell(20,5,$aproba,1,0,'L',$fill);
    $pdf->Cell(50,5,$reprob,1,0,'L',$fill);
    $pdf->Cell(20,5,$claus,1,0,'L',$fill);
    $pdf->Cell(20,5,$usuario,1,0,'L',$fill);
    $pdf->Cell(20,5,$fecha,1,1,'L',$fill);
    $fill=!$fill;
    $i++;
}
